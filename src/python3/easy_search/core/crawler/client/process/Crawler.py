...
from easy_search.interfaces.crawler.client.process.ICrawler import ICrawler
from easy_search.interfaces.crawler.client.process.ICrawlerPlugin import ICrawlerPlugin
from easy_search.interfaces.crawler.client.utils.IDocumentCommunicator import IDocumentCommunicator
