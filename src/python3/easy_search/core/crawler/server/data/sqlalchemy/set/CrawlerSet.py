...
from easy_search.interfaces.crawler.server.data.entity.Crawler import Crawler as CrawlerDTO
from easy_search.interfaces.crawler.server.data.set.ICrawlerSet import ICrawlerSet
